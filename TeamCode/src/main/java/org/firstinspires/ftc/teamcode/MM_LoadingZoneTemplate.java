    ...
    private void linearOpmodeSteps() throws InterruptedException {
        switch (stepNumber) {
            ...
            case 4:
                ...
                // drive to foundation
                robot.driveForwardDistance(distanceToFoundation + distanceToBuildZone - 24, speed, this.opmode);
                this.stepNumber++;
                break;
            case 5:
                Thread.sleep(250);
            ...
            case 10:
                ...
                switch(this.parkingPos) {
                    case FAR:
                        robot.strafeTime(0.4 * colorCoefficient, 1400);
                        break;
                    case CLOSE:
                        robot.strafeTime(-0.4 * colorCoefficient, 625);
                        break;
                }
                this.stepNumber++;
                break;
